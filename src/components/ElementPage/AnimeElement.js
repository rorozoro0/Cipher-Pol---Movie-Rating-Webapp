...
function ElementDisplay(props){
  ...
  function rateNow(e){
    e.preventDefault();
      ...
      Axios.patch(`https://cors-anywhere.herokuapp.com/https://rorolist1.herokuapp.com/api/v1/anime/${randomdata._id}`,{
        rating: {
          avgrating :  avg,
          nviews: views
        }
  ...
  const onLikesClick = () => {
    ...
    Axios.patch(`https://cors-anywhere.herokuapp.com/https://rorolist1.herokuapp.com/api/v1/anime/${randomdata._id}`, {likes: randomdata.likes+1}).then((response) => {
  ...
  return (
    <StyledRoot>
      ...
      <CommentSection id = {props.match.params.id} data = "anime" category = "anime" details = {{rating: randomdata.rating, comments: randomdata.comments}}></CommentSection>
